...
<Update label="July 11, 2026" tags={["Improvements"]} rss={{ title: "EmtellRP Network Chain syntax" }}>

  ## EmtellRP Network Chain syntax

  Added a mathematical Rhontomatrical Sphere syntax page for the EmtellRP Network Chain, including origin measures, Resonance Point emission, transition validation, proof bundle completeness, invariants, and deployment gates.

</Update>

<Update label="March 3, 2026" tags={["Improvements"]} rss={{ title: "Documentation update for CIE workflows and KmtPillarsVault" }}>

  ## Documentation update

  Added a documentation note covering CIE funding and workflow integration, the handshake test execution path update, and `KmtPillarsVault` contract test coverage references for the EmtellRP Network Chain.

  ## Scope

  This changelog entry is a documentation-only update and does not include in-repository smart contract or workflow code changes.
...
<Update label="February 20, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Agent configuration files and custom frontend" }}>
  ...
  Use `.mintlify/Assistant.md` and `.mintlify/AGENTS.md` files in your repository to customize the agent and assistant behaviors. See [Customize assistant behavior](/ai/assistant#customize-assistant-behavior) and [Customize agent behavior](/agent/customize) for more information.

  ## Custom frontend

  Bring your own frontend and use the Mintlify content engine to publish your documentation and enable AI tools. See the [custom frontend guide](/guides/custom-frontend) for more information.
...
<Update label="January 30, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Simplified skills installation, revamped analytics, editor improvements, and more" }}>
  ...
  Manage all [assistant features](/ai/assistant) in one page with a cleaner layout and better UX.
...
<Update label="January 9, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Implicit snippets and assistant conversation insights for all" }}>
  ...
  [Conversation insights](/agent/suggestions#conversation-insights) are now available for all documentation sites that have both the agent and assistant enabled. The agent analyzes patterns in assistant conversations to identify documentation gaps and suggest improvements, helping you proactively address common user questions.
...
<Update label="December 23, 2025" tags={["New releases", "Improvements"]} rss={{ title: "Web editor improvements and assistant insights" }}>
  ...
  The [agent](/agent) can now suggest documentation updates based on [assistant conversations](/agent/suggestions#conversation-insights). When enabled, the agent analyzes questions users ask the assistant to identify patterns that indicate missing or unclear documentation.
...
<Update label="December 19, 2025" tags={["Improvements"]} rss={{ title: "Agent, assistant, and editor improvements" }}>
  ...
  - Agent now opens PRs under your GitHub account if you [connect your account](/agent/quickstart#connect-your-github-account) on the dashboard.
...
<Update label="December 3, 2025" tags={["New releases"]} rss={{ title: "Assistant query bucketing", description: "Automatically group similar assistant queries to identify common user questions" }}>
  ...
  [Assistant insights](https://dashboard.mintlify.com/products/assistant) now automatically groups similar queries together into question categories, which makes it easier to identify patterns in what your users are asking about.
